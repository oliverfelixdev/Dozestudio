...
const Navigation = () => {
  return (
    <nav className="w-full absolute top-0 left-0 z-20 flex items-center justify-start py-7 px-8">
      <div className="w-1/3">
        <a className="flex items-center justify-start gap-4" href="#">
          ...
          <video
            ...
            autoPlay
            muted
            src="./assets/videos/logoanim.mp4"
          ></video>
        </a>
      </div>
      <div className="w-2/3 flex items-center justify-between">
        <div className="flex items-center justify-center gap-3">
          {["Projects,", "About,", "Labs"].map((item, index) => (
            <a key={index} className="text-xl font-[un-sans-medium] leading-none" href="#">
              {item}
            </a>
          ))}
        </div>
